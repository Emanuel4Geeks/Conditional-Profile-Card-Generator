...
function render(variables = {}) {
  ...
  const defaultUser = "4geeksacademy";
    ...
    "Boilett"}</h1>
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/${variables.twitter ||
              defaultUser}"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${variables.github ||
              defaultUser}"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${variables.linkedin ||
              defaultUser}"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${variables.instagram ||
              defaultUser}"><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
